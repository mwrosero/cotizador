<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="row">
        ...
        <div class="col-12 mt-4 text-center">
            <img class="logo-sidebar" src="{{ secure_asset('assets/img/veris/icono-ism-large.svg') }}">
            <img class="logo-sidebar-iso" src="{{ secure_asset('assets/img/veris/isotipo.svg') }}" alt="">
        </div>
    </div>
